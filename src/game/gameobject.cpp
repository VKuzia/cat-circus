...
const QString GameObject::kPathToMinigameImages = "/data/images/minigames/";
...
QString GameObject::GetPathToMinigameImages() {
  return QDir::currentPath() + kPathToMinigameImages;
}
